...
DROP CONSTRAINT IF EXISTS check_participants_is_array;

ALTER TABLE discord_thread_metadata
DROP CONSTRAINT IF EXISTS check_webhook_url_format;

ALTER TABLE discord_thread_metadata
DROP CONSTRAINT IF EXISTS check_last_message_id_format;

ALTER TABLE discord_thread_metadata
DROP CONSTRAINT IF EXISTS check_guild_id_format;

ALTER TABLE discord_thread_metadata
DROP CONSTRAINT IF EXISTS check_channel_id_format;

ALTER TABLE discord_thread_metadata
DROP CONSTRAINT IF EXISTS check_discord_thread_id_format;
...
ALTER TABLE stitches
DROP CONSTRAINT IF EXISTS check_discord_message_fields;
...
ALTER TABLE threads
DROP CONSTRAINT IF EXISTS check_interactive_no_branching;
